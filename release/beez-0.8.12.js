...
(function (global) {
    ...
    ua.setup = function (useragent) {
        ...
        this.os.phone  = !!(!this.os.tablet && (this.android || this.iphone || this.webos || this.blackberry || this.bb10 ||
                                                (this.chrome && useragent.match(/Android/)) || (this.chrome && useragent.match(/CriOS\/([\d.]+)/)) || (this.firefox && useragent.match(/Mobile/))));
    };
...
(function (global) {
    ...
    define('beez-utils/browser',['require','exports','module','beez.core','underscore','zepto','backbone','beez.ua'],function (require, exports, module) {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // // 定数として定義したい＆直前に定義した値を参照したいので                                                 //
        // // オブジェクトリテラルではなくプロパティ代入で定義                                                       //
        // /**                                                                                                       //
        //  * user agent info                                                                                        //
        //  * @namespace Browser~ua                                                                                  //
        //  */                                                                                                       //
        // var ua = {};                                                                                              //
        //                                                                                                           //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * navigatorにandroidが含まれているか                                                                     //
        //  * @name Browser~ua.android                                                                               //
        //  * @type {boolean}                                                                                        //
        //  */                                                                                                       //
        // ua.android = /android/.test(global.navigator.userAgent.toLowerCase());                                    //
        //                                                                                                           //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @name Browser~ua.iPhone                                                                                //
        //  * @type {boolean}                                                                                        //
        //  */                                                                                                       //
        // ua.iPhone = /iphone/.test(global.navigator.userAgent.toLowerCase());                                      //
        //                                                                                                           //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @name Browser~ua.iPad                                                                                  //
        //  * @type {boolean}                                                                                        //
        //  */                                                                                                       //
        // ua.iPad = /ipad/.test(global.navigator.userAgent.toLowerCase()),                                          //
        //                                                                                                           //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @name Browser~ua.iPod                                                                                  //
        //  * @type {boolean}                                                                                        //
        //  */                                                                                                       //
        // ua.iPod = /ipod/.test(global.navigator.userAgent.toLowerCase()),                                          //
        //                                                                                                           //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @name Browser~ua.iOS                                                                                   //
        ...
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @name Browser~ua.supportTouch                                                                          //
        //  * @type {boolean}                                                                                        //
        //  */                                                                                                       //
        // ua.supportTouch = (global.window && global.window.document && ('ontouchmove' in global.window.document)); //
        //                                                                                                           //
        // /**                                                                                                       //
        //  * @export ua as Browser#ua                                                                               //
        //  */                                                                                                       //
        // __Browser__.ua = ua;                                                                                      //
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    define('beez.i18n',['require','exports','module','beez.core','beez.utils','underscore','handlebars'],function __I18n__(require, exports, module) {
        ...
        var __I18n__ = {
            ...
            initialize: function initialize(options) {
                ...
                this.lang.use = this.lang.browser = beez.utils.browser.getLanguage();
                if (!this.lang.use) {
                ...
                if (options.lang.browser) {
                    this.lang.browser = options.lang.browser;
                }
                if (options.lang.use) {
         ...
         * @public
         */
        beez.createI18n = function createI18n(Obj, options) {
            beez.i18n && beez.i18n.dispose();
        ...
        /**
         * i18n Handlebars Register Helper
         *
        ...
        var ManagerBase = beez.extend(
            ...
            function ManagerBase() {},
            {
                ...
                remove: function remove(path) {
                    ...
                    if (!_.isArray(objs)) {
                        objs = [objs]; // array-nize
                    }
                    _.each(objs, function (del) {
                 ...
                 * @param {String} path
                 */
                removeAll: function removeAll(path) {
                    var objs = this.get(path);
                    if (!objs) { return; }
                    ...
                    var deletes = children.concat(objs);
                 ...
                 * @return {Array.<Object>}
                 */
                getChildrenAll: function getChildrenAll(obj) {
                    var result = [];
                    var self = this;
                    ...
                    var _walk = function _walk(list) {
                        _.each(list, function (item) {
                            ...
                            if (_.isArray(item)) {
                                ...
                                if (!item.prefix) { // Item that is not managed to ignore
                                    // result.push(item); // Do not ignore
                                    return;
                                }

                                owalk(item); // Child is at the beginning of the Array
                                result.push(item);
                            }
                        });
                    };

                    var awalk = function awalk(objs) {
                        _walk(objs);
                    };

                    var owalk = function owalk(obj) {
                        _walk(_.values(obj));
                    };
    ...
    define('beez-mvcr/model',['require','exports','module','beez.core','underscore','backbone','zepto','beez-mvcr/base'],function (require, exports, module) {
        ...
        var ModelManager = beez.extend(
            ...
            ManagerBase,
            {
                ...
                /**
                 * exclude target Model/Collection from management and perform the deletion of target Object.
                 *
                 * @memberof ModelManager
                 * @instance
                 * @param {Array|Object} models remove model list
                 * @param {Object} options @see backbone.js#Collection.remove() || Model.dispose()
                 * @return {Model}
                 */
                deepRemove: function deepRemove(path, options) {
                    ...
                    if (obj.isCollection()) {
                        obj.removeAll && obj.removeAll(options);
                    } else {

                        obj.dispose && obj.dispose(options);
                    }

                    ModelManager.__super__.remove.apply(this, arguments);
                    return this;
                },
                ...
                /**
                 * model specified by path is canceled and it removes from management. delete the descendants.
                 ...
                 * @param {String} path
                 */
                dispose: function dispose(path) {
                    logger.debug("ModelManager dispose");

                    var models = this.get(path);
                    if (!models) {
                        return this;
                    }
                    ...
                    var candidates = children.concat(models);
        ...
        var Model = beez.extend(
             ...
             */
            {
                ...
                constructor: function constructor(attribute, options, manager) {
                    ...
                    Model.__super__.constructor.apply(this, newArgs);
                },
    ...
    define('beez-mvcr/view',['require','exports','module','beez.core','underscore','backbone','beez-mvcr/base'],function __View__(require, exports, module) {
        ...
        var ViewManagerAsync = beez.Bucks.extend(
            'beez.mvcr.ViewManagerAsync',
            {
                 ...
                 * @param {Object} [opt_params] Argument of the View object.
                 * @return {ViewManagerAsync}
                 */
                create: function create(prefix, View, opt_params) {
                    var self = this;
                    return this.then(function () {
                        var v =  self.manager.create(prefix, View, opt_params);
                 ...
                 * @return {ViewManagerAsync}
                 */
                child: function child(View, opt_params) {
                    var self = this;
                 ...
                 * @return {Creator}
                 */
                bro: function bro(brother, opt_params) {
                    return this.parent().child(brother, opt_params);
                },
        ...
        var ViewManager = beez.extend(
            ...
            ManagerBase,
            {
                ...
                create: function create(prefix, View, opt_params) {
                    ...
                    if (_.isArray(View)) {
                        return this._createArray(prefix, View, opt_params);
                    }

                    return this._createObj(prefix, View, opt_params);
                },
                 ...
                 * @private
                 */
                _createObj: function _createObj(prefix, View, opt_params) {
                    var v = new View(this, opt_params);
                    if (!this.isAddable(v)) {
                 ...
                 * @private
                 */
                _createArray: function _createArray(prefix, Views, opt_params) {
                    var self = this;
                    // forced array
                    if (opt_params && !_.isArray(opt_params)) {
                        opt_params = [opt_params];
                    }

                    var instances = [];
                    _.each(Views, function (c, idx) {  // new
                        var params = opt_params ? opt_params[idx] : undefined;
                ...
                /**
                 * view specified by path is deleted and it removes from management.
                 *
                 * @memberof ViewManager
                 * @instance
                 * @param {String} path
                ...
                dispose: function dispose(path) {
                    ...
                    var views = this.get(path);

                    if (!views) { return; }
                    if (!_.isArray(views)) {
                        views = [views]; // array-nize
                    }
                    ...
                    // list to delete
                    // is children and this views
                    var deletes = children.concat(views);
        ...
        var View = beez.extend(
            ...
            Backbone.View.prototype,
            {
                ...
                /**
                 * このビューがViewManagerによってrenderされた後に実行されます
                 * もしその後の処理を待たせたい場合は引数としてnextを定義すると nextがコールされるまでその後の処理は 遅延されます。
                 *
                 * @memberof View
                 * @instance
                 * @function
                ...
                /**
                 * このビューがViewManagerによって renderされた後に一度実行されます。
                 * もしその後の処理を待たせたい場合は 引数としてnextを定義すると nextがコールされるまでその後の処理は 遅延されます。
                 * @memberof View
                 * @instance
                 * @function
                 * @param {Function} [next]
                ...
                /**
                 * このViewが保持しているHTMLElementが DOMツリー上に存在するかを返します
                 *
                 * @memberof View
                 * @instance
                 * @function
    ...
    define('beez-mvcr/controller',['require','exports','module','beez.core','beez.mvcr','beez.i18n','underscore'],function __Controller__(require, exports, module) {
        ...
        var ControllerManagerAsync = beez.Bucks.extend(
            'beez.mvcr.ControllerManagerAsync',
            {
                 ...
                 * @param {Object|Array<Object>} [opt_params] Arguments to the Controller
                 * @return {Controller}
                 */
                create: function create(name, Controller, opt_params) {
                    var self = this;
        ...
        var Controller = beez.extend(
            ...
            },
            {
                ...
                loadI18n: function loadI18n(callback) {
                    ...
                    var self = this;
                    require(this.i18n, function () {
                        var list = Array.prototype.slice.call(arguments);
                        for (var i = 0; i < list.length; i++) {
                            beez.i18n.add(list[i]);
                ...
                dispose: function dispose() {
                    ...
                    delete this.constructor.prototype.i18n;
                }
            }
        );
...
(function (global) {
    define('beez-mvcr/router',['require','exports','module','beez.core','beez.mvcr','underscore','backbone'],function (require, exports, module) {
        ...
        var __RouterManager__ = {
            ...
            /**
             * router is initialized and routing is started.
             *
             * @memberof RouterManager
             * @instance
             * @param {Object} [options] overwrite merge the routes pass the set of routes
             * @param {Router} Router Override Router object
             */
            start: function start(options, Router) {
                Router = Router || beez.Router; // extend
                ...
                logger.debug("router.start", JSON.stringify(routes));
                                ...
                                require([data.require], function cnavigate(_Controller) {
                                    ...
                                    if (controller) {
                                        if (!controller[data.name]) {
                                            throw new Error('"' + data.name + '" to Controller I is undefined.');
                                        }
            ...
            navigate: function navigate(fragment, options) {
                if (!this.started || !this.router) {
                    throw new beez.Error(
                        'Initialization has not been performed even once. Please do a "start()".');
                }
    ...
    define('beez-mvcr/imagemanager',['require','exports','module','beez.core','beez.utils','underscore','zepto'],function (require, exports, module) {
        ...
        var ImageManagerAsync = beez.Bucks.extend(
            'beez.mvcr.ImageManagerAsync',
            {
                 ...
                 * }).end();
                 */
                loadOne: function loadOne(url) {

                    var img = this.imageManager.create();
                    var self = this;
                ...
                load: function load(url) {
                    ...
                    // make tasks
                    var self = this;
                    var tasks = _.map(url, function makeTask(u) {
        ...
        var ImageManager = beez.extend(
            ...
            },
            {
                 ...
                 */
                load: function load(url) {
                    return new ImageManagerAsync(this).load(url);
                },
                 ...
                 */
                loadOne: function loadOne(url) {
                    return new ImageManagerAsync(this).loadOne(url);
                },
