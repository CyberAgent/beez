...
(function (global) {
    ...
    define('beez-mvcr/base',['require','exports','module','beez.core','underscore','beez-mvcr/jsonpath'],function (require, exports, module) {
        ...
        var Base = beez.extend(
            ...
            {
                /**
                 * Base Constructor is set by calling function.
                 * @constructor
                 * @memberof Base
                 * @param {String} idxProp base index name
                 */
                ...
                /**
                 * Disposes of the instance, but set this method by calling function.
                 *
                 * @memberof Base
                 * @instance
                 */
    ...
    define('beez-mvcr/model',['require','exports','module','beez.core','underscore','backbone','zepto','beez-mvcr/base'],function (require, exports, module) {
        ...
        var ModelManager = beez.extend(
            ...
            ManagerBase,
            {
                ...
                _decideBindedModel: function _decideBindedModel(obj, isCollection) {
                    var model = (isCollection) ? obj.models : obj;
                    var returnedModel;
                    ...
                    returnedModel = (isCollection) ? obj : deletes;
                ...
                dispose: function dispose() {
                    ...
                    _.each(managedChildren, function (key) {
                        Model.prototype.dispose.apply(key, arguments);
                    });
        ...
        var Model = beez.extend(
             ...
             */
            {
                 ...
                 */
                initialize: function initialize() {
                    // call Backbone.Medel.initialize()
                 ...
                 */
                dispose: function dispose() {
                    var instanceKeys = _.keys(this);

                    logger.debug('Model dispose');
                    Model.__super__.dispose.apply(this, arguments);

                    for (var i = 0, len = instanceKeys.length; i < len; ++i) {
                        delete this[instanceKeys[i]];
                    }
                },
                /**
        ...
        var Collection = beez.extend(
            ...
            Backbone.Collection.prototype,
            {
                ...
                dispose: function dispose() {
                    ...
                    for (var i = 0, l = instanceKeys.length; i < l; i ++) {
                        delete this[instanceKeys[i]];
                    }
                }
            }
        ...
        var ViewManager = beez.extend(
            ...
            ManagerBase,
            {
                ...
                dispose: function dispose() {
                    ...
                    _.each(managedChildren, function (key) {
                        View.prototype.dispose.apply(key, arguments);
                    });
        ...
        var View = beez.extend(
            ...
            Backbone.View.prototype,
            {
                ...
                dispose: function dispose() {
                    ...
                    // delete all self instance
                    for (var i = 0, len = instanceKeys.length; i < len; ++i) {
                        delete this[instanceKeys[i]];
                    }
                },
                /**
                 * Remove HTMLElement and undelegate event if delegate.
                 *
                 * @memberof View
                 * @function
                 * @override Backbone.View.remove / Backbone.View.undelegateEvents
                 * @return
                 */
                remove: function remove() {
                    // call Backbone.remove & undelegateEvents method
                ...
                for (var i = 0; i < names.length; i++) {
                    ...
                    this.router.route(data.route, data.name, (function (name) {
                        function proxy() {
                            ...
                            var controller = beez.manager.c.get(data.xpath); // use controller
