...
(function (global) {
    define('beez-mvcr/router',['require','exports','module','beez.core','beez.mvcr','underscore','backbone'],function (require, exports, module) {
        ...
        var __RouterManager__ = {
             ...
             * @param {Object} [hooks] Interrupt processing of execution before and after the controller. ex) {firstBefore: function, before: function, after:function}
             */
            start: function start(options, hooks) {
                                ...
                                require([data.require], function cnavigate(_Controller) {
                                    ...
                                    if (controller) {
                                        ...
                                        if (hooks.before) {
                                            ...
                                            hooks.before(data); // run before function
                                        }
                                        ...
                                        if (hooks.after) {
                                            ...
                                            hooks.after && hooks.after(data); // run after function
                                        }
